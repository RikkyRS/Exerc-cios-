...
Exercícios para praticar manipulação de arrays e estruturas básicas em Ruby.
...
- A média  (A MEDIA DE NUMEROS IMPARES NÃO É INTEIRO, SE O RESULTADO FOR COM VIRGULA, A MAQUINA NAO EXPOE O VALOR EXATO)
...
- Calcule a média (A MEDIA DE NUMEROS IMPARES NÃO É INTEIRO, SE O RESULTADO FOR COM VIRGULA, A MAQUINA NAO EXPOE O VALOR EXATO)
...
Para executar um exercício específico, você pode comentar os demais ou criar arquivos separados.